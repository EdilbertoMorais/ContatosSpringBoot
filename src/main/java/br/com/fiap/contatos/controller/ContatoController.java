...
public class ContatoController {
    ...
    public ContatoExibicaoDto buscarPeloId(@PathVariable Long id) {
        return contatoService.buscarPeloId(id);
    }

    @GetMapping("/contatos")
    @ResponseStatus(HttpStatus.OK)
    public Page<ContatoExibicaoDto> listarTodos(Pageable paginacao) {
        return contatoService.listarTodos(paginacao);
    }

    @DeleteMapping("/contatos/{id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void excluir(@PathVariable Long id) {
        contatoService.exluir(id);
    }
    ...
    public List<ContatoExibicaoDto> buscarAniversariantes(
        ...
        return contatoService.listarAniversariantesDoPeriodo(dataInicio, dataFim);
    }
